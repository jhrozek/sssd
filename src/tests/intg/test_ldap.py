...
def test_ldap_auto_private_groups_hybrid_priv_group_byname(ldap_conn,
    ...
    # Finally, the autogenerated group for the user with uidNumber==gidNumber must
    # be resolvable
    ent.assert_group_by_name("user_with_no_group", dict(gid=1002, mem=ent.contains_only()))
...
def test_ldap_auto_private_groups_hybrid_priv_group_byid(ldap_conn,
    ...
    # Finally, the autogenerated group for the user with uidNumber==gidNumber must
    # be resolvable
    ent.assert_group_by_gid(1002, dict(name="user_with_no_group", mem=ent.contains_only()))
