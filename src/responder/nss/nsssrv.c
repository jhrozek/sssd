...
static int nss_clear_memcache(struct sbus_request *request);
static int nss_clear_netgroup_hash_table(struct sbus_request *request);
...
static int nss_update_memcache(struct sbus_request *request)
{
    struct resp_ctx *rctx = talloc_get_type(sbus_conn_get_private_data(request->conn),
                                            struct resp_ctx);
...
static int nss_memcache_initgr_check(struct sbus_request *request)
{
    struct resp_ctx *rctx = talloc_get_type(sbus_conn_get_private_data(request->conn),
                                            struct resp_ctx);
    struct nss_ctx *nctx = talloc_get_type(rctx->pvt_ctx, struct nss_ctx);
