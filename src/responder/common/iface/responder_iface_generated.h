...
#define IFACE_RESPONDER_DOMAIN_ENABLE "Enable"
#define IFACE_RESPONDER_DOMAIN_DISABLE "Disable"
...
struct iface_responder_domain {
    ...
    int (*Enable)(struct sbus_request *req, void *data, const char *arg_name);
    int (*Disable)(struct sbus_request *req, void *data, const char *arg_name);
};
