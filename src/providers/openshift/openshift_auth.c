...
{
    struct openshift_auth_ctx *state;
    struct tevent_req *req;

    req = tevent_req_create(mem_ctx, &state, struct openshift_auth_ctx);
    if (req == NULL) {
...
{
    struct openshift_auth_ctx *state = NULL;

    state = tevent_req_data(req, struct openshift_auth_ctx);
